...
# 
# ###############################################################
# source("/dcl02/hongkai/data/rli/covid/wrapup/0509/util.R")
# source("/dcl02/hongkai/data/rli/covid/wrapup/0509/core.R")
# source("/dcl02/hongkai/data/rli/covid/wrapup/0509/core_clean.R")
# source("/dcl02/hongkai/data/rli/covid/wrapup/0509/plot.R")
# 
# 
...
# sample.color = readRDS("/dcl02/hongkai/data/covid/data/current/palette/study.rds")
# 
names(severity.color)[1:4]=c("Healthy","Mild","Moderate","Severe")
# 
# ###############################################################
# source("/dcl01/hongkai/data/ywang/cnsv_multiSample/functions_cnsv_multiSample.R")
# 
# ###############################################################
# setwd("/dcl01/hongkai/data/data/ywang/scATAC/cvd/out/")
# 
# out_=readRDS("out_.rds")
